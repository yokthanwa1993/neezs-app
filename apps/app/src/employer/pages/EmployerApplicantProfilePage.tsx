...
const EmployerApplicantProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="pb-24 max-w-mobile-lg mx-auto px-4 sm:px-5">
        {/* Profile Header */}
          ...
          <div className="py-4">
            ...
            <div className="mt-6 flex justify-center space-x-4">
              <Button
                variant="outline"
                size="icon"
                className="group w-16 h-16 aspect-square rounded-full border border-gray-300 bg-gradient-to-b from-gray-100 to-gray-300 text-gray-700 shadow-sm flex items-center justify-center hover:from-gray-200 hover:to-gray-400 active:translate-y-px focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-gray-300 [&_svg]:transition-transform group-hover:[&_svg]:scale-110"
              >
