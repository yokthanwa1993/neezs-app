...
const AddJob: React.FC = () => {
    ...
    const { isLoading: authLoading, isLogoutInProgress } = useEmployerAuth();
    ...
    if (authLoading || isLogoutInProgress) {
        return <LoadingScreen title="กำลังเตรียมความพร้อม..." subtitle="กำลังตรวจสอบสถานะผู้ใช้และโหลดทรัพยากร"/>;
    }
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
            <div className="w-full max-w-mobile-lg flex-1 flex flex-col justify-center">
                {step === 1 && (
                    <>
            ...
            {/* Removed fixed bottom footer (was overlapping with main navbar) */}
        </div>
    );
};
