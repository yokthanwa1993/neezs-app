...
const mockJobDetail = {
  ...
  images: [
    ...
    'https://images.unsplash.com/photo-1472289065668-ce650ac443d2?w=1200&q=80',
    'https://images.unsplash.com/photo-1526481280698-8fcc13fd2336?w=1200&q=80',
...
const EmployerJobDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Job Images - Smooth slider */}
      <div className="relative">
        <ImageCarousel
          images={mockJobDetail.images || [mockJobDetail.image]}
          heightClass="h-64"
          showArrows={false}
          showDots={false}
        />
      ...
      {/* Job Content */}
      <div className="p-4 space-y-4 pb-24 bottom-nav-spacing">
        {/* Job Title & Price */}
