...
const EmployerProfile: React.FC = () => {
  ...
  const companyProfile = {
    name: user?.displayName || user?.profile?.displayName || 'เทค โซลูชั่นส์ จำกัด',
    logo: user?.profile?.pictureUrl || 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=150&h=150&fit=crop&crop=center',
