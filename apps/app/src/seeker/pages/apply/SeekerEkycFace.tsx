...
const SeekerEkycFace: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 flex flex-col">
      <main className="w-full max-w-mobile-lg mx-auto p-4 flex-1 flex flex-col items-center justify-center text-center">
        <div className="mb-4">
      ...
      <div className="fixed left-1/2 -translate-x-1/2 bottom-20 w-full max-w-mobile-lg px-4 z-40">
        <Button
