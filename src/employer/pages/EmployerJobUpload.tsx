...
// Use employer-specific Firebase instances to ensure auth consistency
import { employerStorage as storage, employerDb as db, employerAuth as auth } from '../lib/employerFirebase';
...
const EmployerJobUpload: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col justify-center">
            <main className="flex-1 w-full max-w-mobile-lg mx-auto p-4 flex flex-col justify-center">
                <Card>
