...
import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription, DialogFooter, DialogTrigger, DialogClose } from '@/shared/components/ui/dialog';
import { 
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            ...
            <footer className="sticky bottom-0 w-full bg-white/80 backdrop-blur-sm border-t p-4">
                <div className="max-w-mobile-lg mx-auto">
